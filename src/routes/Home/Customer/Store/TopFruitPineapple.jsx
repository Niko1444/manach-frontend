	...
	return (
		...
		>
			<img
				...
				src="https://s3-alpha-sig.figma.com/img/27f0/ac45/bdbf0ebf8dd04d4bcc0b052432fa73b7?Expires=1716768000&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=XJKqmzH73AJLvEu4n2RMLtroJYSU8YJNNVqrEqWI9oY3FvtXTn2eUyakhw0LviQk~KFCGFJ0la~051iuVmh2h9gu-aHQ~gGbWtc6888JMIK-qXv5eBA8W0R~ciIiKae0ZEMlv7ekJqMK74u-D44I8V9pHKW7f~dhHcTUNjSORCF~buVqM8msOAgInGz9Ldj8k1nTHsCXzUAQsoY-igaNWGkpfd7J6aRvHu0S4bEfAbJFOZK6uA4jM2svq4H1V~i80Llg-eJvZ5fdh-hyhkSs49B4ZYssmK~OKRTNbDUDr-hv1mI9QsdWEnvA8FwIx5LZLPwkO2s5NYXgmfpY-AKHiQ__"
			/>
			<div className="flex">
				<div
					style={{
			...
			>
				Pineapples, a tropical fruit known for their prickly skin and delicious
				meat, are a rich source of antioxidants, manganese, and vitamins C and
				B6.
			</div>
		</div>
	)
...
export default TopFruitPineapple
